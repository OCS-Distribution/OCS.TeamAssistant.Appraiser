...
internal sealed class MessageBuilder : IMessageBuilder
{
    ...
    private readonly Dictionary<MessageId, string> _store = new()
    {
        ...
        [MessageId.SessionNotFoundForModerator] = "Не найдена сессия {0} для модератора {1}.",
        [MessageId.SessionNotFoundForAppraiser] = "Не найдена сессия {0} для участника {1}. Обратитесь к модератору.",
        ...
        [MessageId.MemoryCleared] = "Память бота очищена.",
        ...
        [MessageId.AddCommandHelp] = "{0}{{task}} - добавление задачи для оценки",
        [MessageId.SetCommandHelp] = "{0}{{3}} - задать оценку",
